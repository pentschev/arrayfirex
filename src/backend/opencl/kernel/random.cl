...
#define R123_0x1p_64 (1.f/(4294967296.*4294967296.))
...
void generate_randu(T *one, T *two, threefry2_ctr_t *c, threefry2_key_t k)
{
...
void generate_randn(T *one, T *two, threefry2_ctr_t *c, threefry2_key_t k)
{
    threefry2_ctr_t r = threefry2(*c, k);
    c->v[0] = c->v[0] + 1;
...
//void generate_randi(T *one, T *two, threefry2_ctr_t *c, threefry2_key_t k)
//{
//    threefry2_ctr_t r = threefry2(*c, k);
//    c->v[0] = c->v[0] + 1;
//
...
#define INSTANTIATE(RTYPE) \
__kernel __attribute__ ((reqd_work_group_size(256, 1, 1))) \
void random_##RTYPE(__global T *output, unsigned numel, \
